  ...
  getOptions: function (mode = 'document', criteria = {}) {
    ...
    let optsArray = [
      ...
      },
      {
        ...
        type: 'enum',
        default: 'Paths',
        availableOptions: ['Paths', 'Tags', 'TagsHierarchical'],
        description: 'Select whether to create folders according to the spec’s paths or tags. TagsHierarchical supports nested folders based on tag hierarchy (e.g., "Admin/Users" creates Admin folder with Users subfolder).',
        external: true,
        usage: ['CONVERSION'],
        supportedIn: [VERSION20, VERSION30, VERSION31],
        supportedModuleVersion: [MODULE_VERSION.V2, MODULE_VERSION.V1]
